...
import com.terminuslabs.smsmessenger.activities.ThreadActivity
import com.terminuslabs.smsmessenger.databases.MessagesDatabase
import com.terminuslabs.smsmessenger.helpers.*
...
import com.terminuslabs.smsmessenger.models.*
import com.terminuslabs.smsmessenger.receivers.DirectReplyReceiver
import com.terminuslabs.smsmessenger.receivers.MarkAsReadReceiver
...
val Context.scheduledMessageDB: ScheduledMessageDao get() = getMessagessDB().ScheduledMessageDao()
...
fun Context.deleteScheduled(scheduledID: Long) {
    scheduledMessageDB.delete(scheduledID)
}
